...
{
      10,     0,    -1,    11,    -1,     3,    12,     5,    11,    -1,
       3,    12,     5,    11,     4,    11,    -1,     6,    -1,     7,
      -1
};
...
{
  "$end", "error", "$undefined", "TOK_I", "TOK_E", "TOK_T", "TOK_A",
  "TOK_B", "LOWER_THAN_ELSE", "$accept", "program", "S", "E", YY_NULL
};
#endif
